...
from pages.food_edit_page import (
    FoodEditPage,
    barcode_food,
    button_go_back,
...
def test_name_edit_discription_food(driver, login_accaunt):
    ...
    food_edit_page.send_keys(input_description_manufacturer, "DescriptionManufacturer")
    ...
    food_diary_page.click(LFD.name_my_manufacturer_select_category, LFD.name_my_product)
